"""
Django settings for noisy_wave_44337 project.
...
ROOT_URLCONF = 'noisy_wave_44337.urls'
...
WSGI_APPLICATION = 'noisy_wave_44337.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "noisy_wave_44337 API",
    "DESCRIPTION": "API documentation for noisy_wave_44337 App",
    "VERSION": "v1",
}
